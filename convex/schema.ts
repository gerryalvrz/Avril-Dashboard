...
export default defineSchema({
  ...
  agents: defineTable({ organizationId: v.id('organizations'), name: v.string(), status: v.union(v.literal('active'), v.literal('paused')), createdAt: v.string() }).index('by_org', ['organizationId']),
  ...
  chats: defineTable({ organizationId: v.optional(v.id('organizations')), title: v.string(), createdAt: v.string(), updatedAt: v.string() }).index('by_org', ['organizationId']).index('by_updatedAt', ['updatedAt']),
